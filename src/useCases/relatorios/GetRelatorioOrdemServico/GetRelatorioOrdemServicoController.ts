...
export class GetRelatorioOrdemServicoController {
    constructor(
        private getRelatorioOrdemServicoUC: GetRelatorioOrdemServicoUC,
    ) {}
    ...
    async handle(request: Request, response: Response): Promise<Response> {
        try {
            ...
            const relatorioResult = await this.getRelatorioOrdemServicoUC.execute({dataDe, dataAte});
