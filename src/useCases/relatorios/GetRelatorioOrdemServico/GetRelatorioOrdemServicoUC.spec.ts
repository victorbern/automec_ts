...
describe("Find Ordem Servico Between Dates", () => {
    ...
    const getRelatorioOrdemServicoUC = new GetRelatorioOrdemServicoUC(findOrdemServicoBetweenDates);
    ...
    it("should be able to find all orders", () => {
        ...
        expect(getRelatorioOrdemServicoUC.execute({ dataDe, dataAte })).resolves.toStrictEqual({
            total: 600,
            subtotalPagas: 200,
            subtotalNaoPagas: 400,
            pagas: [
                {
                    idOrdemServico: 2,
                    total: 100,
    ...
    it("should not be able to find any order", () => {
        ...
        expect(getRelatorioOrdemServicoUC.execute({ dataDe: null, dataAte: null })).rejects.toThrow("Campos faltando");
